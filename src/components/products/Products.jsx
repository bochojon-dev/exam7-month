...
// ChatGPT bilan ham cartSlice.js dagi localStorage -
// code larini to'g'rilab bo'lmadi error lar site ni buzib yubordi
...
//   const wishlist = useSelector((state) => state.wishes.value) || [];
...
//     storedWishes.forEach((item) => dispatch(toogleLike(item)));
//   }, [dispatch]);
...
//           {!btn ? (
//             <div className="btn">
//               <button className="see__more" onClick={loadMore}>
//                 Load More
//               </button>
//             </div>
//           ) : (
